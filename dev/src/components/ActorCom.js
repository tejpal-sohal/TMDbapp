...
function ActorCom({title,poster,text,modal,rate,customeModalId,modalImg,ArrayItems}) {
    return <div className="col-6 col-md-6 col-lg-3">
                    ...
                    <div className="card-body">
                        ...
                        <div className="d-flex justify-content-between align-items-center">
                            <div className="btn-group">
                                <button data-toggle="modal" data-target={modal} type="button" className="btn btn-sm btn-outline-secondary d-none d-sm-block mb-4">Find out more</button>
                            </div>
                        </div>
